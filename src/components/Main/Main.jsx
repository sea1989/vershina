  ...
  return (
    <main>
      <section className='about container'>
        <h2 className='h2'>О нас коротко</h2>
        ...
        <div className='about__mission'>
          ...
          <p>
            АНО по реализации социальных проектов «Вершина» это команда
            поддержки инициатив, направленных на служение обществу. В своей
            работе мы руководствуемся ценностями и принципами открытости и
            прозрачности деятельности, равенства, партнерства и ответственности.
          </p>
        ...
        <div className='about__footer'>
          <div className='about__block'>
            ...
            <p>
              Наш центр – это помощь,обучение и консультационное сопровождение
              для некоммерческих организаций по вопросам:
            </p>
          ...
          <div className='about__block'>
            ...
            <p>
              Мы сопровождаем участников Государственной программы по
              преодолению бедности. В партнерстве со специалистами центра
              социальной поддержки населения Приморского края по Артёмовскому
              городскому округу рассказываем как:
            </p>
